...
const UpdateMutualFundPage = () => {
  ...
  if (fetchError) {
    return (
      <div className="max-w-4xl mx-auto p-6 bg-red-50 rounded-lg shadow">
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800">Update Mutual Fund</h1>
        <p className="text-gray-600">
          Update the details of {formData.scheme_name}
        </p>
      </div>
      ...
      {submitStatus === "success" && (
        <div className="mb-6 bg-green-50 p-4 rounded-md flex items-center text-green-700">
          ...
          <span>Mutual fund successfully updated!</span>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end space-x-3 pt-4 border-t">
          ...
          <button
            type="submit"
            className="px-4 py-2 border cursor-pointer border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
...
export default UpdateMutualFundPage;
